    ...
    <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-stone-900/80 backdrop-blur-xl shadow-sm dark:shadow-none font-sans antialiased tracking-tight">
      <div className="flex justify-between items-center px-6 py-3 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <button 
            onClick={toggleTheme}
            className="material-symbols-outlined text-stone-600 dark:text-stone-400 hover:bg-stone-200 dark:hover:bg-stone-800 p-2 rounded-full transition-colors"
          >
            {theme === 'dark' ? 'light_mode' : 'dark_mode'}
          </button>
          <Link to="/settings" className="material-symbols-outlined text-stone-600 dark:text-stone-400 hover:bg-stone-200 dark:hover:bg-stone-800 p-2 rounded-full transition-colors active:animate-pop">
            settings
          </Link>
          <Link to="/profile">
            <img alt="User profile" className="w-8 h-8 rounded-full border border-outline-variant/15 hover:ring-2 ring-primary/50 transition-all active:animate-pop" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBcdxDjqVtmUa1zxQRzZN_U6i4Zx48CN6BfBynS06q_pw6yCrGv0OoTLa0Np5SBlNztCy_VEBCGrbbx_CZ7mceqUVw37S3yzSPmPZhPtkXpUlrO8rReWwAiYNB1FResJ6r6AjJyp2ud6eSlNCiNB30PKIPULnKeNy89Xr1PRI35M3-fWoWzYUhXNOlwnmw-nRmoaUyE7w0msOD4hK4jrgpllEo9Ln5vEGS4vE8LJds7VgkJyQ_ZDlG2foaeo46jyS4tIgOyeN3H7r0"/>
          </Link>
        </div>
      </div>
    </header>
